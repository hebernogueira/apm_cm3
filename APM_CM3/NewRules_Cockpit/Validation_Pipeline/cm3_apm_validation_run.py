...
coils_string = " '961335', '961964', '962172', '962233', '962321','960865', '961724', '961785', '961787', '961837','961840', '959419', '962035', '962183', '962228','962310', '957328', '958800', '960053', '961923','962025', '960734', '961952', '962243', '962318','962426', '956108', '960904', '960911', '961119','961922', '962083', '962096', '962154', '962329','961486', '962327', '962665', '962764', '962897'"
coils_string
...
sel_query = '''SELECT Coil_ID, Production_date FROM '''+ table_coil_status+ ''' 
               ...
               AND Production_date >= cast({} as DATE) 
               AND Coil_ID not in ({}) '''.format(select_date,coils_string) 
...
if coil_ids:
  ...
  # RUN RULE ENGINE
  #APM_CM3/NewRules_Cockpit/Validation_Pipeline/cm3_alarm_batch_validation
  run_with_retry("cm3_alarm_batch_validation", 600, {"coil_id": ",".join(coil_ids), "production_date": ",".join(production_dates)}, max_retries=1)
