...
STATUS_TABLE = 'daaentdevg2.pba_apm_cm3_validationstatustable'
...
status_table.write.format("delta").mode("append").saveAsTable('daaentdevg2.pba_cpm_cm3_validation')
